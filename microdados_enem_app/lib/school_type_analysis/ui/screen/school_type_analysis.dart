...
import 'package:microdados_enem_app/school_type_analysis/ui/widgets/essay_score_distribution_card.dart';
        ...
        children: [
          Column(
            ...
            children: [
              ...
              BlocProvider(
                create: (_) => EssayScoreDistributionCubit(),
                child: EssayScoreDistributionCard(),
              ),
            ],
          ),
        ],

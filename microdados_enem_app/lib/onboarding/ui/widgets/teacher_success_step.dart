...
class TeacherSuccessStep extends StatelessWidget {
  final VoidCallback onNextStep;

  const TeacherSuccessStep({super.key, required this.onNextStep});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AppText(
          text:
              'Tudo pronto para você mergulhar nos dados e aprimorar ainda mais suas análises!',
